  ...
  return (
	<div className="flex relative">
		<MdMenu 
			...
			className="sm:invisible peer/slide z-20 absolute left-5 top-5 text-3xl text-white"/>
		{/* <input className="peer/slide z-10 absolute left-20 bg-green-500 " type="checkbox" name="name" id="name" /> */}
		<header className={`absolute sm:sticky sm:-left-16 h-screen peer-checked/slide:left-0 ${ slide ? 'left-0' : '-left-40' }  bg-orange-500 flex w-40 sm:w-16 sm:hover:w-40 peer group transition-all overflow-hidden z-10`}>
